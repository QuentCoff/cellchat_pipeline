#!/bin/bash
# run_all.sh
# Full Vtruncated_test pipeline: truncatedMean (trim=0.04)
...
P1_SCRIPT="${BASE_DIR}/Vtruncated_test/src/Rscript/00_prepare_cellchat.R"
P2_DIR="${BASE_DIR}/Vtruncated_test/src/Rscript"

echo "============================================"
echo "  Pipeline: Vtruncated_test (truncatedMean, trim=0.04)"
echo "============================================"
...
echo "  Data:   ${BASE_DIR}/Vtruncated_test/Result/data/"
echo "  Plots:  ${BASE_DIR}/Vtruncated_test/Result/plot/"
echo "============================================"

...
P1_SCRIPT="${BASE_DIR}/Vtruncated_5Clusters_test_020/src/Rscript/00_prepare_cellchat.R"
P2_DIR="${BASE_DIR}/Vtruncated_5Clusters_test_020/src/Rscript"

echo "============================================"
echo "  Pipeline: Vtruncated_5Clusters_test_020 (5 clusters, truncatedMean, trim=0.04)"
echo "============================================"
...
echo "  Data:   ${BASE_DIR}/Vtruncated_5Clusters_test_020/Result/data/"
echo "  Plots:  ${BASE_DIR}/Vtruncated_5Clusters_test_020/Result/plot/"
echo "============================================"

...
P1_SCRIPT="${BASE_DIR}/Vtruncated_5Clusters_test/src/Rscript/00_prepare_cellchat.R"
P2_DIR="${BASE_DIR}/Vtruncated_5Clusters_test/src/Rscript"

echo "============================================"
echo "  Pipeline: Vtruncated_5Clusters_test (5 clusters, truncatedMean, trim=0.04)"
echo "============================================"
...
echo "  Data:   ${BASE_DIR}/Vtruncated_5Clusters_test/Result/data/"
echo "  Plots:  ${BASE_DIR}/Vtruncated_5Clusters_test/Result/plot/"
echo "============================================"

...
# Read from Vtruncated_5Clusters/Result/data/cellchat_prep
rds1 <- file.path(base_dir, "Vtruncated_5Clusters", "Result", "data", "cellchat_prep", prefix1, paste0("cellchat_", prefix1, ".rds"))
rds2 <- file.path(base_dir, "Vtruncated_5Clusters", "Result", "data", "cellchat_prep", prefix2, paste0("cellchat_", prefix2, ".rds"))

# Write merged object to Vtruncated_5Clusters/Result/data/merged
out_dir <- file.path(base_dir, "Vtruncated_5Clusters", "Result", "data", "merged", paste0(prefix1, "_vs_", prefix2))

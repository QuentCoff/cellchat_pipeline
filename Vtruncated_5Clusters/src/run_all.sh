...
P1_SCRIPT="${BASE_DIR}/Vtruncated_5Clusters/src/Rscript/00_prepare_cellchat.R"
P2_DIR="${BASE_DIR}/Vtruncated_5Clusters/src/Rscript"

echo "============================================"
echo "  Pipeline: Vtruncated_5Clusters (5 clusters, truncatedMean, trim=0.04)"
echo "============================================"
...
echo "  Data:   ${BASE_DIR}/Vtruncated_5Clusters/Result/data/"
echo "  Plots:  ${BASE_DIR}/Vtruncated_5Clusters/Result/plot/"
echo "============================================"

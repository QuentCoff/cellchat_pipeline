#!/usr/bin/env Rscript
# 10_dysfunctional_viz.R (SSC_Sertoli)
...
step12_dir <- file.path(base_dir, "results", "SSC_Sertoli", "Procedure_2",
                        paste0(prefix1, "_vs_", prefix2), "comparison", "step12")

out_dir <- file.path(base_dir, "results", "SSC_Sertoli", "Procedure_2",
                     paste0(prefix1, "_vs_", prefix2), "comparison", "step13")
...
cat("\n--- Procedure 2 Step 13 complete (SSC_Sertoli) ---\n")

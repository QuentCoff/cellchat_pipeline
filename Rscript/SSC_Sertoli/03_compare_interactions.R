#!/usr/bin/env Rscript
# 03_compare_interactions.R
# Step 5: Compare total number and strength of interactions
#
# Usage:
#   Rscript 03_compare_interactions.R <prefix1> <prefix2>
...
if (length(args) < 2) {
  stop("Usage: Rscript 03_compare_interactions.R <prefix1> <prefix2>\n")
}
...
print(gg1)
dev.off()
cat("  Saved: compare_interactions_count.png\n")
...
print(gg2)
dev.off()
cat("  Saved: compare_interactions_weight.png\n\n")

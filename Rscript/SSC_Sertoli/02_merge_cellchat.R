#!/usr/bin/env Rscript
# 02_merge_cellchat.R
# Merge CellChat objects for SSC+Sertoli comparison
#
# Usage:
#   Rscript 02_merge_cellchat.R <prefix1> <prefix2> [label1] [label2]
...
if (length(args) < 2) {
  stop("Usage: Rscript 02_merge_cellchat.R <prefix1> <prefix2> [label1] [label2]\n")
}
...
rds1 <- file.path(base_dir, "results", "SSC_Sertoli", "Procedure_1", prefix1, paste0("cellchat_", prefix1, ".rds"))
rds2 <- file.path(base_dir, "results", "SSC_Sertoli", "Procedure_1", prefix2, paste0("cellchat_", prefix2, ".rds"))

out_dir <- file.path(base_dir, "results", "SSC_Sertoli", "Procedure_2", paste0(prefix1, "_vs_", prefix2))

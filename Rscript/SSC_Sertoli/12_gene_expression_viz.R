#!/usr/bin/env Rscript
# 12_gene_expression_viz.R (SSC_Sertoli)
...
rdata_deg <- file.path(base_dir, "results", "SSC_Sertoli", "Procedure_2",
                       paste0(prefix1, "_vs_", prefix2), "comparison", "step12",
                       "cellchat_deg.RData")

out_dir <- file.path(base_dir, "results", "SSC_Sertoli", "Procedure_2",
                     paste0(prefix1, "_vs_", prefix2), "comparison", "step15")
...
cat("\n--- Procedure 2 Step 15 complete (SSC_Sertoli) ---\n")

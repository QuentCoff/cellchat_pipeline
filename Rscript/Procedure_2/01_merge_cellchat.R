...
rds1 <- file.path(base_dir, "results", "Procedure_1", prefix1, paste0("cellchat_", prefix1, ".rds"))
rds2 <- file.path(base_dir, "results", "Procedure_1", prefix2, paste0("cellchat_", prefix2, ".rds"))

out_dir <- file.path(base_dir, "results", "Procedure_2", paste0(prefix1, "_vs_", prefix2))

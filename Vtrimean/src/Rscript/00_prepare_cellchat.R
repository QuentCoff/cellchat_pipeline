...
out_dir  <- file.path(base_dir, "Vtrimean", "Result", "data", "cellchat_prep", out_prefix)
...
cat(paste0("Cells after filtering: ", ncol(seurat_filtered), "\n"))
...
# Step 11: computeCommunProb with triMean (default 10% trimmed mean)

#!/bin/bash
# run_all.sh
# Full Vtrimean pipeline: triMean (default CellChat)
...
P1_SCRIPT="${BASE_DIR}/Vtrimean/src/Rscript/00_prepare_cellchat.R"
P2_DIR="${BASE_DIR}/Vtrimean/src/Rscript"

echo "============================================"
echo "  Pipeline: Vtrimean (triMean)"
echo "============================================"
...
echo "  Data:   ${BASE_DIR}/Vtrimean/Result/data/"
echo "  Plots:  ${BASE_DIR}/Vtrimean/Result/plot/"
echo "============================================"
